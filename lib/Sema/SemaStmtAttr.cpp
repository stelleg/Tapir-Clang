...
CheckForIncompatibleAttributes(Sema &S,
  ...
  // unroll, unroll_and_jam, pipeline and distribute, and Tapir grainsize.
  // Except for distribute they come in two variants: a state form and a
  // numeric form.  The state form selectively defaults/enables/disables the
  // transformation for the loop (for unroll, default indicates full unrolling
  // rather than enabling the transformation). The numeric form form provides
  // an integer hint (for example, unroll count) to the transformer. The
  // following array accumulates the hints encountered while iterating through
  // the attributes to check for compatibility.
  struct {
